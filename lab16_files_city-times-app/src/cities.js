import { uk, enGB, enUS, ja, fr, de, ptBR, tr, ar, it, enCA, ko, hi } from 'date-fns/locale';
export const cities = [
  ...
  { name: 'Рим', zone: 'Europe/Rome', locale: it },
  { name: 'Торонто', zone: 'America/Toronto', locale: enCA },
  { name: 'Сеул', zone: 'Asia/Seoul', locale: ko },
  { name: 'Мумбаї', zone: 'Asia/Kolkata', locale: hi }
];